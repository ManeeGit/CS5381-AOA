...
**Student Name:** Lakshman Pukhraj  
**Configuration:** Conservative (Low Mutation) (ID: 3)  
**Date:** April 12, 2026  
...
This report presents experimental results for the Evolve evolutionary algorithm system using the **Conservative (Low Mutation)** configuration. The system was tested on two benchmark problems: Pacman Agent Optimization and 3x3 Matrix Multiplication.
...
The experiment ran for **12 generations** with the following progression:
...
The **Conservative (Low Mutation)** configuration was designed to low mutation rate with larger population for careful refinement. Key observations:

- **Population Size (10):** Balanced population size for standard exploration-exploitation trade-off
- **Mutation Rate (0.2):** Low mutation favors exploitation of known good solutions
- **Top-K Selection (4):** Selective elitism maintains diversity while preserving best candidates
...
3. **Configuration Impact:** The Conservative (Low Mutation) configuration (low mutation rate with larger population for careful refinement) achieved its design objectives
